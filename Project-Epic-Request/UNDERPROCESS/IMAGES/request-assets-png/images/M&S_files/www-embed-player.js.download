...
t(Dh,wh);var Eh=new xh("aft-recorded"),Fh=new xh("timing-sent");function Gh(){var a;(a=z("ytcsi.data_"))||(a={tick:{},info:{}},Ja("ytcsi.data_",a));return a}
function Hh(){var a=Gh().nonce;a||(a=Gg(),Gh().nonce=a);return a}
;function Ih(){var a=Gh();if(!("gel"in a))a.gel={gelTicks:{},gelInfos:{}};else if(a.gel){var b=a.gel;b.gelInfos||(b.gelInfos={});b.gelTicks||(b.gelTicks={})}return a.gel}
...
function Qh(){Gh().info.yt_lt="hot_bg";if(Rh()){var a="hot_bg",b=Ih();(b.gelInfos?b.gelInfos:b).info_yt_lt=!0;if("yt_lt"in Kh){var c=Kh.yt_lt;0<=Ka(Mh,c)&&(a=!!a);"yt_lt"in Oh&&(a=Oh.yt_lt+a.toUpperCase());b={};c=c.split(".");for(var d=b,e=0;e<c.length-1;e++)d[c[e]]=d[c[e]]||{},d=d[c[e]];d[c[c.length-1]]=a;Rh()&&(a=Gh(),"gelInfo"in a||(a.gelInfo={}),rh(a.gelInfo,b),a=Hh(),c=Object.keys(b).join(""),ph("info_"+c+"_"+a)||(b.clientActionNonce=a,mh("latencyActionInfo",b)))}else 0<=Ka(Lh,"yt_lt")||(b=Error("Unknown label logged with GEL CSI"),
b.params="yt_lt",fe(b))}}
...
A(X.clearResourceTimings||X.webkitClearResourceTimings||X.mozClearResourceTimings||X.msClearResourceTimings||X.oClearResourceTimings||xa,X);function Th(){return Gh().tick}
function Uh(){var a=Th(),b=a.pbr,c=a.vc;a=a.pbs;return b&&c&&a&&b<c&&c<a&&1==Gh().info.yt_pvis}
function Rh(){return!!R("csi_on_gel")||!!Gh().useGel}
function Vh(){Bh();if(!Rh()){var a=Th(),b=Gh().info,c=a._start;for(f in a)if(0==f.lastIndexOf("_",0)&&Aa(a[f])){var d=f.slice(1);if(d in Jh){var e=Na(a[f],function(l){return Math.round(l-c)});
b["all_"+d]=e.join()}delete a[f]}e=P("CSI_SERVICE_NAME","youtube");var f={v:2,s:e,action:P("TIMING_ACTION",void 0)};d=Qh.srt;void 0!==a.srt&&delete b.srt;if(b.h5jse){var g=window.location.protocol+z("ytplayer.config.assets.js");(g=X.getEntriesByName?X.getEntriesByName(g)[0]:null)?b.h5jse=Math.round(b.h5jse-g.responseEnd):delete b.h5jse}a.aft=Sh();Uh()&&"youtube"==e&&(Qh(),e=a.vc,g=a.pbs,delete a.aft,b.aft=Math.round(g-e));for(var h in b)"_"!=h.charAt(0)&&(f[h]=b[h]);a.ps=Sf();h={};e=[];for(var k in a)"_"!=
...
var Qi=ee(function(){var a="ol";X.mark&&(0==a.lastIndexOf("mark_",0)||(a="mark_"+a),X.mark(a));a=Th();var b=Sf();a.ol&&(a._ol=a._ol||[a.ol],a._ol.push(b));a.ol=b;a=Ah();if(b=a.ol)uf(b),a.ol=0;a=Rh();b=Ih();b.gelTicks&&(b.gelTicks.tick_ol=!0);Sf();a?(a=Hh(),ph("tick_ol_"+a)||mh("latencyActionTicked",{tickName:"ol",clientActionNonce:a},{timestamp:void 0}),a=!0):a=!1;if(a=!a)a=!z("yt.timing.pingSent_");if(a&&(b=P("TIMING_ACTION",void 0),a=Th(),z("ytglobal.timingready_")&&b&&a._start&&(b=Sh()))){Ph||
(zh(Eh,new Ch(Math.round(b-a._start),void 0)),Ph=!0);b=!0;var c=P("TIMING_WAIT",[]);if(c.length)for(var d=0,e=c.length;d<e;++d)if(!(c[d]in a)){b=!1;break}b&&Vh()}a=Di.getInstance();c=!!((Gi("f"+(Math.floor(119/31)+1))||0)&67108864);b=1<window.devicePixelRatio;document.body&&Xc(document.body,"exp-invert-logo")&&(b&&!Xc(document.body,"inverted-hdpi")?(d=document.body,d.classList?d.classList.add("inverted-hdpi"):Xc(d,"inverted-hdpi")||(d.className+=0<d.className.length?" inverted-hdpi":"inverted-hdpi")):
!b&&Xc(document.body,"inverted-hdpi")&&Yc());c!=b&&(c="f"+(Math.floor(119/31)+1),d=Gi(c)||0,d=b?d|67108864:d&-67108865,0==d?delete Z[c]:(b=d.toString(16),Z[c]=b.toString()),a.save())}),Ri=ee(function(){var a=Hi;
